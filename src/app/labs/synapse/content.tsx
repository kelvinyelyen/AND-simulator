    ...
    sections: [
        {
            ...
            content: (
                <div className="p-4 bg-zinc-900/40 rounded-lg border border-zinc-800/50 text-sm leading-relaxed text-zinc-300 shadow-inner">
                    <p>
                        When an action potential reaches the axon terminal, it triggers the release of <strong className="text-emerald-400">neurotransmitters</strong> into the synaptic cleft.
                    </p>
                ...
                <div className="p-4 bg-zinc-900/40 rounded-lg border border-zinc-800/50 text-sm leading-relaxed text-zinc-300 shadow-inner">
                    ...
                    <ul className="space-y-2 ml-1">
                        <li className="flex items-start gap-2">
                            <div className="mt-1.5 w-1 h-1 bg-amber-500 rounded-full shrink-0" />
        ...
        },
        {
            ...
            content: (
                <div className="p-4 bg-zinc-900/50 rounded-lg border border-zinc-800/50 text-sm leading-relaxed text-zinc-400">
                    <p>
                        Whether a synapse is <strong className="text-emerald-400">excitatory</strong> (EPSP) or <strong className="text-rose-400">inhibitory</strong> (IPSP) depends on the reversal potential <InlineMath math="E_{syn}" />:
                    </p>
