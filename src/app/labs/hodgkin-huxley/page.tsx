        ...
        <header className="h-14 border-b border-zinc-900 flex items-center justify-between px-6 bg-zinc-950 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-base font-semibold tracking-tight text-white">
              ...
              <span className="text-zinc-400 font-medium">The Hodgkin-Huxley Engine</span>
            </h1>
          </div>
          <div className="flex items-center gap-4">
        ...
        <main className="flex-1 flex overflow-hidden p-6 gap-6">
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.15em] text-zinc-600 font-mono">HH Equations</span>
                  </div>
                  <div className="bg-black/30 rounded-xl p-4 flex flex-col items-center justify-center border border-zinc-800/30 text-zinc-200 text-sm">
                    ...
                    <div className="text-[10px] text-zinc-500 mt-1 pt-2 border-t border-zinc-800/30 w-full text-center space-y-1">
              ...
              <div className="space-y-4 pt-6 mt-6 border-t border-zinc-800/50">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center text-xs font-mono bg-zinc-950/50 p-2 rounded border border-zinc-800/50 gap-3">
                    <span className="text-zinc-400 w-24 shrink-0">Max <InlineMath math="g_{Na}" /></span>
                    <Slider
                    ...
                    />
                    <span className="text-blue-400 font-bold w-12 text-right tabular-nums">{params.gNa}</span>
                  </div>

                  <div className="flex justify-between items-center text-xs font-mono bg-zinc-950/50 p-2 rounded border border-zinc-800/50 gap-3">
                    <span className="text-zinc-400 w-24 shrink-0">Max <InlineMath math="g_K" /></span>
                    <Slider
                      ...
                      className="flex-1 cursor-pointer"
                    />
                    <span className="text-emerald-400 font-bold w-12 text-right tabular-nums">{params.gK}</span>
                  </div>
                </div>
              </div>
          ...
          <section className="flex-1 flex flex-col gap-6 min-w-0">
            ...
            <div className="flex-[1.5] bg-zinc-900/30 border border-zinc-800 rounded-2xl overflow-hidden flex flex-col relative shadow-inner p-4">
              <span className="absolute top-4 left-4 z-10 text-sm font-black text-zinc-500 font-mono uppercase tracking-tighter">Membrane Voltage (mV)</span>
            ...
            <div className="flex-[1] bg-zinc-900/30 border border-zinc-800 rounded-2xl overflow-hidden flex flex-col relative shadow-inner p-4">
              <div className="absolute top-4 left-4 z-10 flex flex-col">
                <span className="text-sm font-black text-zinc-500 font-mono uppercase tracking-tighter">Instantaneous Conductances</span>
                <div className="flex items-center gap-4 mt-2 text-[10px] font-mono font-bold">
                  <div className="flex items-center gap-1"><div className="w-2 h-2 bg-blue-500 rounded-full"></div><span className="text-blue-500">g_Na</span></div>
                  <div className="flex items-center gap-1"><div className="w-2 h-2 bg-emerald-500 rounded-full"></div><span className="text-emerald-500">g_K</span></div>
                </div>
              </div>
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={history} margin={{ top: 30, right: 10, bottom: 10, left: 10 }}>
                  ...
                  <Line type="monotone" dataKey="gNa_inst" stroke="#3b82f6" strokeWidth={2} dot={false} isAnimationActive={false} />
                  <Line type="monotone" dataKey="gK_inst" stroke="#10b981" strokeWidth={2} dot={false} isAnimationActive={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="flex-[1] bg-zinc-900/30 border border-zinc-800 rounded-2xl overflow-hidden flex flex-col relative shadow-inner p-4">
              <div className="absolute top-4 left-4 z-10 flex flex-col">
                <span className="text-sm font-black text-zinc-500 font-mono uppercase tracking-tighter">Gating Variables</span>
                <div className="flex items-center gap-4 mt-2 text-[10px] font-mono font-bold">
                  ...
                  <div className="flex items-center gap-1"><div className="w-2 h-2 bg-emerald-500 rounded-full"></div><span className="text-emerald-500">n (K open)</span></div>
                </div>
              </div>
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={history} margin={{ top: 30, right: 10, bottom: 10, left: 10 }}>
                  ...
                  <Line type="monotone" dataKey="m" stroke="#ef4444" strokeWidth={2} dot={false} isAnimationActive={false} />
                  <Line type="monotone" dataKey="h" stroke="#f97316" strokeWidth={2} dot={false} isAnimationActive={false} />
                  <Line type="monotone" dataKey="n" stroke="#10b981" strokeWidth={2} dot={false} isAnimationActive={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
