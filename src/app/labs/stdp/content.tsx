    ...
    sections: [
        {
            ...
            content: (
                <div className="p-4 bg-zinc-900/40 rounded-lg border border-zinc-800/50 text-sm leading-relaxed text-zinc-300 shadow-inner">
                    ...
                    <p>
                        Where <InlineMath math="\Delta t = t_{post} - t_{pre}" />. A positive <InlineMath math="\Delta t" /> means the pre-synaptic neuron fired <strong className="text-emerald-400">before</strong> the post-synaptic neuron.
                    </p>
                </div>
            )
        },
                ...
                <div className="p-4 bg-zinc-900/40 rounded-lg border border-zinc-800/50 text-sm leading-relaxed text-zinc-300 shadow-inner">
                    ...
                    <ul className="space-y-2 ml-1">
                        <li className="flex items-start gap-2">
                            ...
                            <span><strong className="text-emerald-400">LTP</strong> (<InlineMath math="\Delta t > 0" />): Pre fires <em>before</em> Post → the input helped <em>cause</em> the spike → <strong>strengthen</strong> the synapse.</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="mt-1.5 w-1 h-1 bg-rose-500 rounded-full shrink-0" />
                            <span><strong className="text-rose-400">LTD</strong> (<InlineMath math="\Delta t < 0" />): Pre fires <em>after</em> Post → the input was <em>not causal</em> → <strong>weaken</strong> the synapse.</span>
                        </li>
                    </ul>
                </div>
            )
