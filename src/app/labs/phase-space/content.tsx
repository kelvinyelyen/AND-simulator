    ...
    sections: [
        {
            ...
            content: (
                <div className="p-4 bg-neutral-900/40 rounded-lg border border-neutral-800/50 text-sm leading-relaxed text-neutral-300 shadow-inner">
                    <p>
                        Instead of plotting <InlineMath math="V" /> vs. time, we plot the membrane voltage <InlineMath math="V" /> against a <strong className="text-teal-400">Recovery Variable</strong> <InlineMath math="W" />.
                    </p>
                ...
                <div className="p-4 bg-neutral-900/40 rounded-lg border border-neutral-800/50 text-sm leading-relaxed text-neutral-300 shadow-inner">
                    ...
                    <ul className="space-y-2 ml-1">
                        <li className="flex items-start gap-2">
                            ...
                            <span><strong className="text-teal-400">V-Nullcline</strong> (<InlineMath math="dV/dt = 0" />): A cubic curve. The system can only move <em>horizontally</em> when crossing it.</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="mt-1.5 w-1 h-1 bg-teal-500 rounded-full shrink-0" />
                            <span><strong className="text-teal-400">W-Nullcline</strong> (<InlineMath math="dW/dt = 0" />): A straight line. The system can only move <em>vertically</em> when crossing it.</span>
                        </li>
                    </ul>
